...
class MultiRoomEnvN12S8(MultiRoomEnv):
    def __init__(self):
        super().__init__(
            minNumRooms=12,
            maxNumRooms=12,
...
class MultiRoomEnvN24S10(MultiRoomEnv):
    def __init__(self):
        super().__init__(
            minNumRooms=16,
            maxNumRooms=16,
...
register(
    id='MiniGrid-MultiRoom-N12-S8-v0',
    entry_point='gym_minigrid.envs:MultiRoomEnvN12S8'
)
...
register(
    id='MiniGrid-MultiRoom-N24-S10-v0',
    entry_point='gym_minigrid.envs:MultiRoomEnvN24S10'
)
